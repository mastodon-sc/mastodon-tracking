...
class BoundingBoxControlPanel extends JPanel
{
	...
	public BoundingBoxControlPanel( final BoundingBoxModel model, final ViewerPanel viewer, final SetupAssignments setupAssignments, final Interval rangeInterval, final boolean showBoxSource, final boolean showBoxOverlay )
	{
		...
		add( boxModePanel, BorderLayout.SOUTH );
	}
