...
import static org.mastodon.tracking.TrackerKeys.DEFAULT_ALLOW_GAP_CLOSING;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_ALLOW_TRACK_MERGING;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_ALLOW_TRACK_SPLITTING;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_ALTERNATIVE_LINKING_COST_FACTOR;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_BLOCKING_VALUE;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_CUTOFF_PERCENTILE;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_GAP_CLOSING_FEATURE_PENALTIES;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_GAP_CLOSING_MAX_DISTANCE;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_GAP_CLOSING_MAX_FRAME_GAP;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_LINKING_FEATURE_PENALTIES;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_LINKING_MAX_DISTANCE;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_MERGING_FEATURE_PENALTIES;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_MERGING_MAX_DISTANCE;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_SPLITTING_FEATURE_PENALTIES;
import static org.mastodon.tracking.TrackerKeys.DEFAULT_SPLITTING_MAX_DISTANCE;
